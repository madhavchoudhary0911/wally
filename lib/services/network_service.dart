...
class NetworkService {
  Future<List<PhotoModel>> fetchPhotos(String searchQuery) async {
    ...
    final response =
        await http.get(url, headers: {"Authorization": apiKey}); //TODO: replace apiKey with your own API key
  ...
  List<PhotoModel> parsePhotos(String responseBody) {
    ...
    return parsed['photos'].map<PhotoModel>((json) => PhotoModel.fromJson(json)).toList();
  }
}
